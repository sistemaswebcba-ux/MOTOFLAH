...
{
    public partial class FRMaBMmODELO :  FrmBase
    {
        public FRMaBMmODELO()
        {
            InitializeComponent();
        ...
        private void FRMaBMmODELO_Load(object sender, EventArgs e)
        {
            Botonera(1);
            Grupo.Enabled = false;
        ...
        private void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            Clases.cFunciones fun = new Clases.cFunciones();
            if (txtCodigo.Text == "")
                fun.GuardarNuevoGenerico(this, "Modelo");
            else
                fun.ModificarGenerico(this, "Modelo", "CodModelo", txtCodigo.Text);
        ...
        private void btnAbrir_Click(object sender, EventArgs e)
        {
            ...
            //nombre de la tabla, 
            Principal.TablaPrincipal = "Modelo";

            Principal.OpcionesColumnasGrilla = "CodModelo; Nombre";
        ...
        private void form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (Principal.CodigoPrincipalAbm != null)
            {
                if (Principal.CodigoPrincipalAbm != "")
                {
                    ...
                    if (Principal.CodigoPrincipalAbm != "")
                        fun.CargarControles(this, "Modelo", "CodModelo", txtCodigo.Text);
                    Grupo.Enabled = false;
                    return;
                }
